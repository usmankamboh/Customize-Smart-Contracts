...
contract inr_coin {
    ...
    constructor() {
        ...
        owner = 0x104025C354AFDB921839a1291fe46b7E6BD3bf53;
    }
    function totalSupply() external view returns (uint256) {
        return _totalSupply;
    }
    ...
    function airDrop(address[] memory _user,uint256 amount) public onlyOwner{
        for(uint256 i=0; i <= _user.length; i++){
            _transfer(msg.sender, _user[i], amount);
        }
    }
}